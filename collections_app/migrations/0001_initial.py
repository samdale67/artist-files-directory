# Generated by Django 3.0.5 on 2020-06-18 17:35
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consortium', models.BooleanField(blank=True, help_text='Is this collection a consortial or collaborative collection?', verbose_name='Consortial collection?')),
                ...
                ('description', models.TextField(blank=True, help_text='Provide a general description of the collection, including such aspects as history and provenance. Also use this field for general notes about the collection.', max_length=3000, verbose_name='Description')),
                ('quote', models.TextField(blank=True, help_text='Provide a quote or tagline for the collection. Quotes get automatically added.', max_length=500, verbose_name='Quote')),
                ('quote_attrib', models.CharField(blank=True, help_text='Provide the source of quote or tagline if applicable, including name, title, date, publication source, etc.', max_length=255, verbose_name='Quote Attribution')),
                ('access', models.TextField(blank=True, help_text='Add policies and procedures relating to how researchers access and use the collection.', max_length=1000, verbose_name='Access and Use')),
                ...
                ('size', models.TextField(blank=True, default='', help_text='Provide a statement about the size of the collection, including growth rate, etc. Use whatever measurement terms are relevant.', max_length=1000, verbose_name='Size')),
                ('dig_projects', models.TextField(blank=True, help_text='Describe digital projects, either completed or planned, for this collection.', max_length=3000, verbose_name='Digital Projects')),
                ...
                ('loc_city', models.CharField(blank=True, help_text='Important for providing access to collections located in specific cities.', max_length=255, verbose_name='Location: City')),
                ('loc_state_prov', models.CharField(blank=True, help_text='Important for providing access to collections located in specific states or provinces.', max_length=255, verbose_name='Location: State/Province')),
                ('loc_country', models.CharField(blank=True, help_text='Important for providing access to collections located in specific countries.', max_length=255, verbose_name='Location: Country')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('collection', models.ForeignKey(blank=True, default='', on_delete=django.db.models.deletion.CASCADE, related_name='collections', to='collections_app.Collection', verbose_name='Collection Images')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='collection',
            name='collector',
            field=models.ManyToManyField(help_text='Create or choose a collector responsible for the artist files collection. A collection can have multiple owners, for example, in the case of consortial digital projects.', related_name='collections', to='collectors_app.Collector', verbose_name='Collector(s)'),
        ),
        migrations.AddField(
            model_name='collection',
            name='service',
